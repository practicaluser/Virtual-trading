...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="p-4 bg-gray-800 text-white fixed top-0 w-full z-10 flex justify-between items-center">
      {/* 1. 증권사 로고 추가 */}
      <div className="text-lg font-bold flex items-center">
        ...
        >
          {/* 👇 이 부분을 수정했습니다. */}
          <img
            src={logoImage} // import한 변수를 src에 연결합니다.
            alt="Ascend Capital 로고"
            className="h-8 w-auto mr-2" // 높이와 여백 조정
          />
          <span className="hidden sm:inline">Ascend Capital</span>
        </Link>
      </div>
...
//     {/* 💡 DashboardPage를 HomePage 안에 렌더링 */}
//     <div className="w-full max-w-5xl bg-white text-black rounded-lg shadow-lg p-6">
//       <DashboardPage />
//     </div>
//   </div>
// )
    ...
    <>
      ...
      <div className="pt-16">
        ...
        <Routes>
          ...
          {/* /stock/:stockCode 경로를 추가합니다.
          :stockCode 부분은 동적으로 변하는 URL 파라미터가 됩니다.*/}
