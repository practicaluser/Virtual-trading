...
urlpatterns = [
    ...
    path('orders/pending/', views.PendingOrderListView.as_view(), name='pending-order-list'),

    # ▼▼▼▼▼ 주문 취소 URL ▼▼▼▼▼
    # POST /api/trading/orders/{order_id}/cancel/
    path('orders/<int:order_id>/cancel/', views.CancelOrderView.as_view(), name='order-cancel'),
]