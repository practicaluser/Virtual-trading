...
class CrawlStocksCommandTest(TestCase):
    ...
    def test_sync_stocks_logic(self, mock_get):
        ...
        Stock.objects.create(stock_code='000001', stock_name='상장폐지된 주식', market_type='KOSPI')
        Stock.objects.create(stock_code='005930', stock_name='삼성전자 (구형)', market_type='KOSPI')
        Stock.objects.create(stock_code='035720', stock_name='카카오', market_type='KOSPI')
